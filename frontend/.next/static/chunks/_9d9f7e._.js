(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_9d9f7e._.js", {
...
function SucursalContent({ handleCard }) {
    ...
    const handleCreateSucursal = async ()=>{
        try {
            ...
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchData"])("/sucursales", "POST", nuevaSucursal);
            if (res && res.message) {
                setCardData([
                    ...cardData,
                    nuevaSucursal
...
_s(SucursalContent, "671NVB+6BcvELcNhmvJEWchQvXY=", false, function() {
    return [
...
//# sourceMappingURL=_9d9f7e._.js.map