(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_833f18._.js", {
...
(()=>{
    const e = new Error("Cannot find module '@/components/SwalComponent'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module '@/components/CreateSucursal'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
;
...
function SucursalCards({ handleRoute }) {
    ...
    const handleCreateSucursal = async ()=>{
        if (!session?.user) return;
        showSwal(CreateSucursal, {
            title: 'Un Swal con React'
        });
    /* try {
      const nuevaSucursal = {
...
//# sourceMappingURL=_833f18._.js.map