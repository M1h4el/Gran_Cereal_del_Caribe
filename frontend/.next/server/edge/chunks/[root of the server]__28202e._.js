...
function middleware(req) {
    ...
    console.log("🔹 Token:", token ? "Existe sesión" : "No hay sesión"); // Verifica si hay sesión
    if (![
        "/",
        "/dashboard"
    ].some((route)=>nextUrl.pathname.startsWith(route))) {
        console.log("🔹 Ruta no permitida:", nextUrl.pathname);
        return token ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$spec$2d$extension$2f$response$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/", req.url)) : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$spec$2d$extension$2f$response$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/dashboard", req.url));
    }
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$middleware$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["withAuth"])({
        pages: {
            signIn: "/"
        }
    })(req);
