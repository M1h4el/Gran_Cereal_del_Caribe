...
async function GET(_, { params }) {
    try {
        ...
        if (!userId || isNaN(Number(userId))) {
            return new Response("Invalid or missing userId", {
                status: 400
            });
        }
        const [users] = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dbUtils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryDB"])('SELECT codeCollaborator, email, phone, address, role, userName FROM users WHERE user_id = ?', [
            userId
        ]);
        if (users.length === 0) return Response.json({
...
async function PUT(req, { params }) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dbUtils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryDB"])('UPDATE users SET name = ?, email = ?, role = ? WHERE user_id = ?', [
            name,
            email,
            role,
            userId
...
async function DELETE(_, { params }) {
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dbUtils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryDB"])('DELETE FROM users WHERE user_id = ?', [
            params.iduser
        ]);
        return Response.json({
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__5aa042._.js.map