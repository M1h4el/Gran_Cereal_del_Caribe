...
"[project]/utils/api.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/api/users/[userId]/children/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/utils/api.js [app-route] (ecmascript)");
;
;
async function GET(req, { params }) {
    try {
        ...
        const [users] = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dbUtils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryDB"])(`SELECT u.userName, u.role, u.address, u.phone, u.bought_sold FROM users u, relaciones r, sucursales s WHERE u.user_id = r.user_child_id AND r.user_parent_id = 7 AND s.sucursal_id = r.sucursal_id;
    `, [
            userId
        ]);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__f5e177._.js.map