...
async function GET(req) {
    try {
        ...
        let result;
        if (productCode) {
            result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dbUtils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryDB"])("SELECT productCode, name, inventory FROM products WHERE sucursal_id = ? AND productCode = ?", [
                sucursalId,
                productCode
            ]);
        } else {
            result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dbUtils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryDB"])(`SELECT p.* 
         FROM products p 
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__34a75f._.js.map