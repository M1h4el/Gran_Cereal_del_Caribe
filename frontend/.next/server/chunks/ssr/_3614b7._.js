...
function SucursalContent({ handleCard }) {
    ...
    const handleCreateSucursal = async ()=>{
        try {
            ...
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchData"])("/sucursales", "POST", nuevaSucursal);
            if (res && res.message) {
                setCardData([
                    ...cardData,
                    nuevaSucursal
...
//# sourceMappingURL=_3614b7._.js.map