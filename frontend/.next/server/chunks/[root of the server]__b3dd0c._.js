...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/lib/db.js [app-route] (ecmascript)"); // Asegúrate de que tu conexión está en /lib/db.js
;
;
;
async function POST(req) {
    try {
        ...
        const [existingUser] = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["pool"].query("SELECT * FROM users WHERE email = ?", [
            email
        ]);
        ...
        const [result] = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["pool"].query("INSERT INTO users (userName, email, password) VALUES (?, ?, ?)", [
            userName,
            email,
            hashedPassword
        ]);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__b3dd0c._.js.map